...
manifest while historical semantic review is open. The strict baseline is defined by the reviewed ledger. BLD-02, BLD-03, BLD-11, BLD-12 and all historical FX have now been explicitly reconciled; BLD-13 and BLD-09 have now been manually regenerated and semantically approved; unresolved work remains in six building families and 24 character sheets.
