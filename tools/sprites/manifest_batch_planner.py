...
The planner excludes animation-heavy character/machine sheets and terrain
connectors from the generic static lane. Already-materialized candidates/runtime
files are skipped even if the manifest ledger has not yet been reconciled.
