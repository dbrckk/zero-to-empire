...
WORK=Path('/kaggle/working');REPO=Path('/tmp/zero-to-empire');OUT=WORK/'output';COUNT=int(os.getenv('SPRITE_COUNT','42'));SEED=int(os.getenv('SPRITE_SEED',str(int(time.time())%2_000_000_000)))
