...
| BLD-00-T3 | Street Stand T3 | Foundry / Street Stand — automated complex, visible logistics flow, more verticality and emissive accents. | `app/src/main/res/drawable-nodpi/zte_business_00_t3_final.webp` | RUNTIME |
