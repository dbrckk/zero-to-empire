...
| BLD-00-T4 | Street Stand T4 | Foundry / Street Stand — advanced district-scale facility, dense machinery, premium materials and strong landmark read. | `app/src/main/res/drawable-nodpi/zte_business_00_t4_final.webp` | RUNTIME |
| BLD-00-T5 | Street Stand T5 | Foundry / Street Stand — late-game megastructure, multi-stage production, large moving assemblies and energy routing. | `app/src/main/res/drawable-nodpi/zte_business_00_t5_final.webp` | RUNTIME |
| BLD-00-T6 | Street Stand T6 | Foundry / Street Stand — ultimate mastered structure, iconic silhouette, maximal verticality, prestige crown/hero treatment. | `app/src/main/res/drawable-nodpi/zte_business_00_t6_final.webp` | RUNTIME |
| BLD-01-T0 | Corner Shop T0 | Foundry / Corner Shop — starter footprint, improvised materials, low verticality, one clear production cue. | `app/src/main/res/drawable-nodpi/zte_business_01_t0_final.webp` | RUNTIME |
| BLD-01-T1 | Corner Shop T1 | Foundry / Corner Shop — reinforced footprint, dedicated machinery, cleaner structure, stronger silhouette. | `app/src/main/res/drawable-nodpi/zte_business_01_t1_final.webp` | RUNTIME |
| BLD-01-T2 | Corner Shop T2 | Foundry / Corner Shop — commercialized/industrial expansion, second active subsystem, larger footprint. | `app/src/main/res/drawable-nodpi/zte_business_01_t2_final.webp` | RUNTIME |
| BLD-01-T3 | Corner Shop T3 | Foundry / Corner Shop — automated complex, visible logistics flow, more verticality and emissive accents. | `app/src/main/res/drawable-nodpi/zte_business_01_t3_final.webp` | TODO |
| BLD-01-T4 | Corner Shop T4 | Foundry / Corner Shop — advanced district-scale facility, dense machinery, premium materials and strong landmark read. | `app/src/main/res/drawable-nodpi/zte_business_01_t4_final.webp` | TODO |
| BLD-01-T5 | Corner Shop T5 | Foundry / Corner Shop — late-game megastructure, multi-stage production, large moving assemblies and energy routing. | `app/src/main/res/drawable-nodpi/zte_business_01_t5_final.webp` | TODO |
| BLD-01-T6 | Corner Shop T6 | Foundry / Corner Shop — ultimate mastered structure, iconic silhouette, maximal verticality, prestige crown/hero treatment. | `app/src/main/res/drawable-nodpi/zte_business_01_t6_final.webp` | TODO |
| BLD-02-T0 | Furnace Stall T0 | Foundry / Furnace Stall — starter footprint, improvised materials, low verticality, one clear production cue. | `app/src/main/res/drawable-nodpi/zte_business_02_t0_final.webp` | TODO |
| BLD-02-T1 | Furnace Stall T1 | Foundry / Furnace Stall — reinforced footprint, dedicated machinery, cleaner structure, stronger silhouette. | `app/src/main/res/drawable-nodpi/zte_business_02_t1_final.webp` | TODO |
| BLD-02-T2 | Furnace Stall T2 | Foundry / Furnace Stall — commercialized/industrial expansion, second active subsystem, larger footprint. | `app/src/main/res/drawable-nodpi/zte_business_02_t2_final.webp` | TODO |
| BLD-02-T3 | Furnace Stall T3 | Foundry / Furnace Stall — automated complex, visible logistics flow, more verticality and emissive accents. | `app/src/main/res/drawable-nodpi/zte_business_02_t3_final.webp` | TODO |
| BLD-02-T4 | Furnace Stall T4 | Foundry / Furnace Stall — advanced district-scale facility, dense machinery, premium materials and strong landmark read. | `app/src/main/res/drawable-nodpi/zte_business_02_t4_final.webp` | TODO |
| BLD-02-T5 | Furnace Stall T5 | Foundry / Furnace Stall — late-game megastructure, multi-stage production, large moving assemblies and energy routing. | `app/src/main/res/drawable-nodpi/zte_business_02_t5_final.webp` | TODO |
| BLD-02-T6 | Furnace Stall T6 | Foundry / Furnace Stall — ultimate mastered structure, iconic silhouette, maximal verticality, prestige crown/hero treatment. | `app/src/main/res/drawable-nodpi/zte_business_02_t6_final.webp` | TODO |
| BLD-03-T0 | Assembly Hub T0 | Foundry / Assembly Hub — starter footprint, improvised materials, low verticality, one clear production cue. | `app/src/main/res/drawable-nodpi/zte_business_03_t0_final.webp` | TODO |
| BLD-03-T1 | Assembly Hub T1 | Foundry / Assembly Hub — reinforced footprint, dedicated machinery, cleaner structure, stronger silhouette. | `app/src/main/res/drawable-nodpi/zte_business_03_t1_final.webp` | TODO |
