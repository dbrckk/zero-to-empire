...
| BLD-01-T3 | Corner Shop T3 | Foundry / Corner Shop — automated complex, visible logistics flow, more verticality and emissive accents. | `app/src/main/res/drawable-nodpi/zte_business_01_t3_final.webp` | RUNTIME |
