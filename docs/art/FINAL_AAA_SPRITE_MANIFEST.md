...
|---|---|---|---|---|
| MCH-00-0 | Street Stand machine 1 | Foundry business 00: primary production mechanism; isolated moving parts, loop-safe pivot and 6–16 frame budget if animated. | `app/src/main/res/drawable-nodpi/zte_machine_00_0_final.webp` | RUNTIME |
| MCH-00-1 | Street Stand machine 2 | Foundry business 00: secondary logistics/energy mechanism; isolated moving parts, loop-safe pivot and 6–16 frame budget if animated. | `app/src/main/res/drawable-nodpi/zte_machine_00_1_final.webp` | RUNTIME |
| MCH-01-0 | Corner Shop machine 1 | Foundry business 01: primary production mechanism; isolated moving parts, loop-safe pivot and 6–16 frame budget if animated. | `app/src/main/res/drawable-nodpi/zte_machine_01_0_final.webp` | RUNTIME |
...
| MCH-05-0 | Expansion Business 05 machine 1 | Expansion business 05: primary production mechanism; isolated moving parts, loop-safe pivot and 6–16 frame budget if animated. | `app/src/main/res/drawable-nodpi/zte_machine_05_0_final.webp` | RUNTIME |
...
| MCH-06-0 | Expansion Business 06 machine 1 | Expansion business 06: primary production mechanism; isolated moving parts, loop-safe pivot and 6–16 frame budget if animated. | `app/src/main/res/drawable-nodpi/zte_machine_06_0_final.webp` | RUNTIME |
| MCH-06-1 | Expansion Business 06 machine 2 | Expansion business 06: secondary logistics/energy mechanism; isolated moving parts, loop-safe pivot and 6–16 frame budget if animated. | `app/src/main/res/drawable-nodpi/zte_machine_06_1_final.webp` | RUNTIME |
...
| MCH-07-1 | Expansion Business 07 machine 2 | Expansion business 07: secondary logistics/energy mechanism; isolated moving parts, loop-safe pivot and 6–16 frame budget if animated. | `app/src/main/res/drawable-nodpi/zte_machine_07_1_final.webp` | RUNTIME |
| MCH-08-0 | Megastructure Business 08 machine 1 | Megastructure business 08: primary production mechanism; isolated moving parts, loop-safe pivot and 6–16 frame budget if animated. | `app/src/main/res/drawable-nodpi/zte_machine_08_0_final.webp` | RUNTIME |
| MCH-08-1 | Megastructure Business 08 machine 2 | Megastructure business 08: secondary logistics/energy mechanism; isolated moving parts, loop-safe pivot and 6–16 frame budget if animated. | `app/src/main/res/drawable-nodpi/zte_machine_08_1_final.webp` | RUNTIME |
| MCH-09-0 | Megastructure Business 09 machine 1 | Megastructure business 09: primary production mechanism; isolated moving parts, loop-safe pivot and 6–16 frame budget if animated. | `app/src/main/res/drawable-nodpi/zte_machine_09_0_final.webp` | RUNTIME |
| MCH-09-1 | Megastructure Business 09 machine 2 | Megastructure business 09: secondary logistics/energy mechanism; isolated moving parts, loop-safe pivot and 6–16 frame budget if animated. | `app/src/main/res/drawable-nodpi/zte_machine_09_1_final.webp` | RUNTIME |
