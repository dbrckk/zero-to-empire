...
| BLD-02-T1 | Furnace Stall T1 | Foundry / Furnace Stall — reinforced footprint, dedicated machinery, cleaner structure, stronger silhouette. | `app/src/main/res/drawable-nodpi/zte_business_02_t1_final.webp` | RUNTIME |
| BLD-02-T2 | Furnace Stall T2 | Foundry / Furnace Stall — commercialized/industrial expansion, second active subsystem, larger footprint. | `app/src/main/res/drawable-nodpi/zte_business_02_t2_final.webp` | RUNTIME |
| BLD-02-T3 | Furnace Stall T3 | Foundry / Furnace Stall — automated complex, visible logistics flow, more verticality and emissive accents. | `app/src/main/res/drawable-nodpi/zte_business_02_t3_final.webp` | RUNTIME |
