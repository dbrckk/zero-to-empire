...
|---|---|---|---|---|
| BLD-00-T0 | Street Stand T0 | Foundry / Street Stand — starter footprint, improvised materials, low verticality, one clear production cue. | `app/src/main/res/drawable-nodpi/zte_business_00_t0_final.webp` | TODO |
| BLD-00-T1 | Street Stand T1 | Foundry / Street Stand — reinforced footprint, dedicated machinery, cleaner structure, stronger silhouette. | `app/src/main/res/drawable-nodpi/zte_business_00_t1_final.webp` | TODO |
...
| BLD-01-T0 | Corner Shop T0 | Foundry / Corner Shop — starter footprint, improvised materials, low verticality, one clear production cue. | `app/src/main/res/drawable-nodpi/zte_business_01_t0_final.webp` | TODO |
