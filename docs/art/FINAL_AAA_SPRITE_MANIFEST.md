...
| BLD-01-T1 | Corner Shop T1 | Foundry / Corner Shop — reinforced footprint, dedicated machinery, cleaner structure, stronger silhouette. | `app/src/main/res/drawable-nodpi/zte_business_01_t1_final.webp` | TODO |
| BLD-01-T2 | Corner Shop T2 | Foundry / Corner Shop — commercialized/industrial expansion, second active subsystem, larger footprint. | `app/src/main/res/drawable-nodpi/zte_business_01_t2_final.webp` | TODO |
