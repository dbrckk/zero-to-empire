    ...
    Canvas(modifier.size(iconSize)) {
        ...
        when (id) {
            0 -> {
                ...
                if (stage >= 5) drawCircle(Color(0xFFFFE87A).copy(alpha=.7f), s*.43f, Offset(s*.5f,s*.5f), style=Stroke(s*.014f))
            }
            1 -> {
                ...
                if (stage >= 3) {
                    ...
                    drawCircle(Color.White.copy(alpha=.85f),s*.015f,Offset(s*.15f,s*.74f));drawCircle(Color.White.copy(alpha=.85f),s*.015f,Offset(s*.85f,s*.74f))
                }
                if (stage >= 4) {
                ...
                if (stage >= 5) drawCircle(Color(0xFFB8F1FF).copy(alpha=.75f),s*.44f,Offset(s*.5f,s*.5f),style=Stroke(s*.013f))
            }
            2 -> {
                ...
                if (stage >= 5) drawCircle(Color(0xFFFFD073).copy(alpha=.75f),s*.44f,Offset(s*.5f,s*.5f),style=Stroke(s*.014f))
            }
            3 -> {
                ...
                if (stage >= 5) drawCircle(Color(0xFFFF72D8).copy(alpha=.68f),s*.45f,Offset(s*.5f,s*.5f),style=Stroke(s*.014f))
            }
        }
    }
}
